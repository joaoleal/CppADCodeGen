...
-------------------------------------------------------------------------- */
#ifndef CPPAD_CODEGEN_FORWARD_CODE_GEN_SWEEP_INCLUDED
#define CPPAD_CODEGEN_FORWARD_CODE_GEN_SWEEP_INCLUDED
    ...
    while (op != EndOp) {
        ...
        switch (op) {
            ...
            case CSumOp:
                ...
                forward_code_gen_csum_op(s_out, names, d, i_var, arg, num_par, parameter);
                break;
                // -------------------------------------------------
