...
inline CppAD::ADFun<Base>* Distillation(std::vector<CppAD::DaeVarInfo>& daeVar,
    ...
    var[11] = 1 - var[5];
    var[10] = (0.59999999999999998 * pow(((var[10] + sqrt(0.0001 + var[10] * var[10])) / 2) / 0.66400000000000003, 1.5) * var[9]) / (0.018015283300000001 * var[5] + 0.046068440000000002 * var[11]);
    var[9] = var[5] * var[10];
    ...
    var[19] = 1 - var[13];
    var[18] = (0.59999999999999998 * pow(((var[18] + sqrt(0.0001 + var[18] * var[18])) / 2) / 0.66400000000000003, 1.5) * var[17]) / (0.018015283300000001 * var[13] + 0.046068440000000002 * var[19]);
    var[17] = var[13] * var[18];
    res[2] = var[12] + var[9] - var[17] - var[4] - dmWater__2dt;
    ...
    var[27] = 1 - var[21];
    var[26] = (0.59999999999999998 * pow(((var[26] + sqrt(0.0001 + var[26] * var[26])) / 2) / 0.66400000000000003, 1.5) * var[25]) / (0.018015283300000001 * var[21] + 0.046068440000000002 * var[27]);
    ...
    var[36] = 1 - var[30];
    var[35] = (0.59999999999999998 * pow(((var[35] + sqrt(0.0001 + var[35] * var[35])) / 2) / 0.66400000000000003, 1.5) * var[34]) / (0.018015283300000001 * var[30] + 0.046068440000000002 * var[36]);
    ...
    var[44] = 1 - var[38];
    var[43] = (0.59999999999999998 * pow(((var[43] + sqrt(0.0001 + var[43] * var[43])) / 2) / 0.66400000000000003, 1.5) * var[42]) / (0.018015283300000001 * var[38] + 0.046068440000000002 * var[44]);
    var[42] = var[38] * var[43];
    res[5] = var[34] + var[37] - var[28] - var[42] - dmWater__5dt;
    ...
    var[52] = 1 - var[46];
    var[51] = (0.59999999999999998 * pow(((var[51] + sqrt(0.0001 + var[51] * var[51])) / 2) / 0.66400000000000003, 1.5) * var[50]) / (0.018015283300000001 * var[46] + 0.046068440000000002 * var[52]);
    var[50] = var[46] * var[51];
    res[6] = var[42] + var[45] - var[50] - var[37] - dmWater__6dt;
    ...
    res[10] = var[57] + var[10] - var[18] - var[56] - dmEthanol__2dt;
    ...
    res[13] = var[35] + var[61] - var[59] - var[43] - dmEthanol__5dt;
    var[62] = yEthanol__7 * V__6;
    var[51] = var[52] * var[51];
    res[14] = var[43] + var[62] - var[51] - var[61] - dmEthanol__6dt;
    var[63] = 1 - var[53];
    ...
    var[65] = T__1 * T__1;
    var[64] = T__2 * T__2;
    res[18] = (V__2 * (yWater__3 * 0.00052052999999999995 * pow(1 - T__3 / 647, 0.31990000000000002 + (-0.21199999999999999 * T__3) / 647 + ((0.25795000000000001 * T__3) / 647 * T__3) / 647) + yEthanol__3 * 50430 * pow(1 - T__3 / 514, 0.49890000000000001) * exp((0.44750000000000001 * T__3) / 514)) + 0.018015283300000001 * var[12] * (1851.9275797344801 * T__3 + 3881998.0699387612 / tanh(2610.5 / T__3) - 577255.64604360121 * tanh(1169 / T__3) - (1851.9275797344801 * T__3 + 3881998.0699387612 / tanh(2610.5 / T__3) - 577255.64604360121 * tanh(1169 / T__3))) + 0.046068440000000002 * var[57] * (1067.9762544596692 * T__3 + 5261440.5002643894 / tanh(1662.8 / T__3) - 1517900.9751578306 * tanh(744.70000000000005 / T__3) - (1067.9762544596692 * T__3 + 5261440.5002643894 / tanh(1662.8 / T__3) - 1517900.9751578306 * tanh(744.70000000000005 / T__3))) + 0.018015283300000001 * var[9] * (15340.863387921299 * (T__1 - T__2) + -58.009079435348092 * (T__1 * T__1 - T__2 * T__2) + 0.1503353174209219 * (T__1 * T__1 * T__1 - T__2 * T__2 * T__2) + -0.00019588923145049848 * (T__1 * T__1 * T__1 * T__1 - T__2 * T__2 * T__2 * T__2) + 1.0402389841962685e-07 * (var[65] * var[65] * T__1 - var[64] * var[64] * T__2)) + 0.046068440000000002 * var[10] * (2227.989486945944 * (T__1 - T__2) + -1.5154626464451586 * (T__1 * T__1 - T__2 * T__2) + -0.00021953568791707875 * (T__1 * T__1 * T__1 - T__2 * T__2 * T__2) + 1.1062888172466876e-05 * (T__1 * T__1 * T__1 * T__1 - T__2 * T__2 * T__2 * T__2)) - V__1 * (yWater__2 * 0.00052052999999999995 * pow(1 - T__2 / 647, 0.31990000000000002 + (-0.21199999999999999 * T__2) / 647 + ((0.25795000000000001 * T__2) / 647 * T__2) / 647) + yEthanol__2 * 50430 * pow(1 - T__2 / 514, 0.49890000000000001) * exp((0.44750000000000001 * T__2) / 514))) / (var[15] * (var[14] * (15340.863387921299 + -116.01815887069618 * T__2 + 0.45100595226276569 * T__2 * T__2 + -0.00078355692580199391 * T__2 * T__2 * T__2 + 5.2011949209813426e-07 * T__2 * T__2 * T__2 * T__2) + var[16] * (2227.989486945944 + -3.0309252928903172 * T__2 + -0.00065860706375123624 * T__2 * T__2 + 4.4251552689867506e-05 * T__2 * T__2 * T__2))) - dT__2dt;
    var[64] = T__2 * T__2;
    var[65] = T__3 * T__3;
    ...
    var[58] = T__5 * T__5;
    var[18] = T__6 * T__6;
    res[22] = (0.018015283300000001 * var[42] * (15340.863387921299 * (T__5 - T__6) + -58.009079435348092 * (T__5 * T__5 - T__6 * T__6) + 0.1503353174209219 * (T__5 * T__5 * T__5 - T__6 * T__6 * T__6) + -0.00019588923145049848 * (T__5 * T__5 * T__5 * T__5 - T__6 * T__6 * T__6 * T__6) + 1.0402389841962685e-07 * (var[58] * var[58] * T__5 - var[18] * var[18] * T__6)) + 0.046068440000000002 * var[43] * (2227.989486945944 * (T__5 - T__6) + -1.5154626464451586 * (T__5 * T__5 - T__6 * T__6) + -0.00021953568791707875 * (T__5 * T__5 * T__5 - T__6 * T__6 * T__6) + 1.1062888172466876e-05 * (T__5 * T__5 * T__5 * T__5 - T__6 * T__6 * T__6 * T__6)) + V__6 * (yWater__7 * 0.00052052999999999995 * pow(1 - T__7 / 647, 0.31990000000000002 + (-0.21199999999999999 * T__7) / 647 + ((0.25795000000000001 * T__7) / 647 * T__7) / 647) + yEthanol__7 * 50430 * pow(1 - T__7 / 514, 0.49890000000000001) * exp((0.44750000000000001 * T__7) / 514)) + 0.018015283300000001 * var[45] * (1851.9275797344801 * T__7 + 3881998.0699387612 / tanh(2610.5 / T__7) - 577255.64604360121 * tanh(1169 / T__7) - (1851.9275797344801 * T__7 + 3881998.0699387612 / tanh(2610.5 / T__7) - 577255.64604360121 * tanh(1169 / T__7))) + 0.046068440000000002 * var[62] * (1067.9762544596692 * T__7 + 5261440.5002643894 / tanh(1662.8 / T__7) - 1517900.9751578306 * tanh(744.70000000000005 / T__7) - (1067.9762544596692 * T__7 + 5261440.5002643894 / tanh(1662.8 / T__7) - 1517900.9751578306 * tanh(744.70000000000005 / T__7))) - V__5 * (yWater__6 * 0.00052052999999999995 * pow(1 - T__6 / 647, 0.31990000000000002 + (-0.21199999999999999 * T__6) / 647 + ((0.25795000000000001 * T__6) / 647 * T__6) / 647) + yEthanol__6 * 50430 * pow(1 - T__6 / 514, 0.49890000000000001) * exp((0.44750000000000001 * T__6) / 514))) / (var[48] * (var[47] * (15340.863387921299 + -116.01815887069618 * T__6 + 0.45100595226276569 * T__6 * T__6 + -0.00078355692580199391 * T__6 * T__6 * T__6 + 5.2011949209813426e-07 * T__6 * T__6 * T__6 * T__6) + var[49] * (2227.989486945944 + -3.0309252928903172 * T__6 + -0.00065860706375123624 * T__6 * T__6 + 4.4251552689867506e-05 * T__6 * T__6 * T__6))) - dT__6dt;
    var[18] = T__6 * T__6;
    var[58] = T__7 * T__7;
    var[62] = 0.018015283300000001 * mWater__7;
    var[43] = var[62] + 0.046068440000000002 * mEthanol__7;
    var[62] = var[62] / var[43];
    res[23] = (0.018015283300000001 * var[50] * (15340.863387921299 * (T__6 - T__7) + -58.009079435348092 * (T__6 * T__6 - T__7 * T__7) + 0.1503353174209219 * (T__6 * T__6 * T__6 - T__7 * T__7 * T__7) + -0.00019588923145049848 * (T__6 * T__6 * T__6 * T__6 - T__7 * T__7 * T__7 * T__7) + 1.0402389841962685e-07 * (var[18] * var[18] * T__6 - var[58] * var[58] * T__7)) + 0.046068440000000002 * var[51] * (2227.989486945944 * (T__6 - T__7) + -1.5154626464451586 * (T__6 * T__6 - T__7 * T__7) + -0.00021953568791707875 * (T__6 * T__6 * T__6 - T__7 * T__7 * T__7) + 1.1062888172466876e-05 * (T__6 * T__6 * T__6 * T__6 - T__7 * T__7 * T__7 * T__7)) - V__6 * (yWater__7 * 0.00052052999999999995 * pow(1 - T__7 / 647, 0.31990000000000002 + (-0.21199999999999999 * T__7) / 647 + ((0.25795000000000001 * T__7) / 647 * T__7) / 647) + yEthanol__7 * 50430 * pow(1 - T__7 / 514, 0.49890000000000001) * exp((0.44750000000000001 * T__7) / 514)) + 1000 * Qsteam) / (var[43] * (var[62] * (15340.863387921299 + -116.01815887069618 * T__7 + 0.45100595226276569 * T__7 * T__7 + -0.00078355692580199391 * T__7 * T__7 * T__7 + 5.2011949209813426e-07 * T__7 * T__7 * T__7 * T__7) + (1 - var[62]) * (2227.989486945944 + -3.0309252928903172 * T__7 + -0.00065860706375123624 * T__7 * T__7 + 4.4251552689867506e-05 * T__7 * T__7 * T__7))) - dT__7dt;
    var[62] = 101325 * P;
