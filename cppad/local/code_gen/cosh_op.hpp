#ifndef CPPAD_CODE_GEN_COSH_OP_INCLUDED
#define CPPAD_CODE_GEN_COSH_OP_INCLUDED
 ...
 */
template <class Base>
inline void forward_code_gen_cosh_op(
        std::ostream& s_out,
    ...
    if (d == 0) {
        s_out << sy_d << " = sinh(" << sx_d << ")" << n.endl();
        s_out << sz_d << " = cosh(" << sx_d << ")" << n.endl();
    } else {
 ...
 */
template <class Base>
inline void forward_code_gen_cosh_op_0(
        std::ostream& s_out,
        CodeGenNameProvider<Base>& n,
        size_t i_z,
        size_t i_x) {
    ...
    s_out << sy_0 << " = sinh(" << sx_0 << ")" << n.endl();
    s_out << sz_0 << " = cosh(" << sx_0 << ")" << n.endl();
}
...
template <class Base>
inline void reverse_code_gen_cosh_op(
std::ostream& s_out,
CodeGenNameProvider<Base>& n,
size_t d,
size_t i_z,
