#ifndef CPPAD_CODE_GEN_TAN_OP_INCLUDED
#define CPPAD_CODE_GEN_TAN_OP_INCLUDED
...
template <class Base>
inline void reverse_code_gen_tan_op(
std::ostream& s_out,
CodeGenNameProvider<Base>& n,
size_t d,
size_t i_z,
