#ifndef CPPAD_CODE_GEN_ASIN_OP_INCLUDED
#define CPPAD_CODE_GEN_ASIN_OP_INCLUDED
 ...
 */
template <class Base>
inline void forward_code_gen_asin_op(
        std::ostream& s_out,
 ...
 */
template <class Base>
inline void forward_code_gen_asin_op_0(
        std::ostream& s_out,
        CodeGenNameProvider<Base>& n,
        size_t i_z,
        size_t i_x) {
...
template <class Base>
inline void reverse_code_gen_asin_op(
std::ostream& s_out,
CodeGenNameProvider<Base>& n,
size_t d,
size_t i_z,
