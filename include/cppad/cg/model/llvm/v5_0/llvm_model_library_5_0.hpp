#ifndef CPPAD_CG_LLVM_MODEL_LIBRARY_5_0_INCLUDED
#define CPPAD_CG_LLVM_MODEL_LIBRARY_5_0_INCLUDED
/* --------------------------------------------------------------------------
...
/**
 * Class used to load JIT'ed models by LLVM 5.0
 * 
 * @author Joao Leal
 */
template<class Base>
class LlvmModelLibrary5_0 : public LlvmModelLibrary<Base> {
protected:
...
public:
    ...
    LlvmModelLibrary5_0(std::unique_ptr<llvm::Module> module,
    ...
    LlvmModelLibrary5_0(const LlvmModelLibrary5_0&) = delete;
    LlvmModelLibrary5_0& operator=(const LlvmModelLibrary5_0&) = delete;

    inline virtual ~LlvmModelLibrary5_0() {
        this->cleanUp();
    }
